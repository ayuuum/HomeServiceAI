...
export default function InboxContent() {
  ...
  return (
    <div className="flex overflow-hidden border rounded-lg mt-3" style={{ height: 'calc(100vh - 220px)' }}>
      {/* Conversation List */}
      <div className={cn(
        ...
        {selectedConversation ? (
          <>
            <div className="p-4 border-b bg-card flex items-center gap-3">
              <button onClick={handleBackToList} className="md:hidden p-2 -ml-2 hover:bg-muted rounded-lg">
