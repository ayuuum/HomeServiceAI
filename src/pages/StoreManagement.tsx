        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <Button onClick={() => {
              ...
              setIsModalOpen(true);
            }} className="w-full sm:w-auto btn-primary shadow-subtle h-12 px-6">
        ...
        {isLoading ? (
          ...
          <Card>
            <CardContent className="text-center py-12">
              <Icon name="business" size={48} className="mx-auto text-muted-foreground mb-4" />
          ...
          >
            {stores.map((store) => (
              <motion.div key={store.id} variants={item} whileHover={{ y: -5 }}>
                <Card className="hover:shadow-medium transition-all duration-300 border-none shadow-subtle overflow-hidden group">
                  <div className="h-32 bg-muted relative">
                    <div className="absolute inset-0 flex items-center justify-center text-muted-foreground/20">
                      <Icon name="business" size={48} />
                    </div>
                    {store.is_hq && (
